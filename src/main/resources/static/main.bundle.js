...
var PartyComponent = (function () {
    ...
    PartyComponent.prototype.ngAfterViewInit = function () {
        ...
        this.activatedRoute.params.subscribe(function (params) {
            ...
            _this.partyServiceSubscription = _this.partyService.partyIdSourceObservable.subscribe(function (id) {
                _this.partyId = id;
    ...
    PartyComponent.prototype.makeDataRequest = function () {
        var _this = this;
        this.serverService.getRequestByPartyId(this.partyId, null, { params: 'projection=partyProjection' })
            .subscribe(function (data) {
            _this.data = data;
        }, function (error) {
            console.log(error);
        });
        this.serverService.getRequestByPartyId(this.partyId, '/bills')
            .subscribe(function (bills) {
            _this.partyBills = bills._embedded.bills;
        }, function (error) {
            console.log(error);
        });
        this.serverService.getRequestByPartyId(this.partyId, '/invoices')
